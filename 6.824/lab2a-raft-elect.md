...
完整的、可以直接拿来抄的代码，请看[我的GitHub仓库](https://github.com/Anarion-zuo/MIT-6.824)。当然，真的直接抄就没意思了，不自己操作一遍，你的损失特别大！我不想成为剥夺你学习机会的带恶人。
...
-   我的完整实现请看[我的GitHub仓库](https://github.com/Anarion-zuo/MIT-6.824)，**不要照抄！！！**
...
完整代码过于冗长，机械地贴在这里只会空占篇幅。这里只抽象讲解我的实现框架，具体完整代码请看[我的GitHub仓库](https://github.com/Anarion-zuo/MIT-6.824)。
...
还是那句话，完整代码请看[我的GitHub仓库](https://github.com/Anarion-zuo/MIT-6.824)。
...
如某进程**发起选举**，一定要等到所有进程都进行投票之后，才继续执行**发送心跳信号**等其它动作。其它进程不会因**没有及时收到RequestVote**而发生拖延，但可能因为**没有及时收到AppendEntries**而发生拖延。最终，整个集群固然可以正确运行，但是效率受到极大影响。
